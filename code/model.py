...
class KGEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma, 
        ...
        if model_name not in ['TransE', 'DistMult', 'ComplEx', 'RotatE', 'pRotatE','TransERR']:
    ...
    def _calc(self, h, r):
        s_a, x_a, y_a, z_a = torch.chunk(h, 4, dim=2)
        s_b, x_b, y_b, z_b = torch.chunk(r, 4, dim=2)
        ...
        return torch.cat([A, B, C, D], dim=2)
    ...
    def q_norm(self, r):
        ...
        return torch.cat([s_b, x_b, y_b, z_b], dim=2)
