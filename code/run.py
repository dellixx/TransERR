...
def main(args):
    args.save_path = 'log/%s/%s/%s-%s/%s'%(args.model, args.dataset, args.hidden_dim, args.gamma, time.time()) if args.save_path == None else args.save_path
    ...
    if args.do_train:
        ...
        for step in range(init_step, args.max_steps):
            ...
            if step / args.max_steps in warm_up_ratio:    
